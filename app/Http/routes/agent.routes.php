...
Route::group(['prefix' => 'agent','middleware' => ['auth', 'agent|salesman'] ], function() {
    ...
    Route::get('test', ['as' => 'agent.test', 'uses' => 'Agent\TestController@test']); // test page route
    Route::post('testAjax', ['as' => 'agent.testAjax', 'uses' => 'Agent\TestController@testAjax']); // test ajax request route
});
?>